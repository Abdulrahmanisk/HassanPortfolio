...
export default function VideoCard({
  ...
  return (
    <div className="group w-full max-w-sm h-full bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transform hover:scale-105 transition-all duration-300 animate-fadeInCard">
      {/* Thumbnail */}
