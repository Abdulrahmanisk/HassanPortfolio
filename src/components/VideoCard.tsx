  ...
  return (
    <div className="group h-full bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transform hover:scale-105 transition-all duration-300 animate-fadeInCard">
      ...
      <div className="relative h-48 overflow-hidden bg-gradient-to-br from-gray-200 to-gray-300">
        ...
        <div
          className={`absolute top-4 right-4 bg-gradient-to-r ${platformColor} text-white px-4 py-2 rounded-full text-sm font-bold transform -translate-y-2 group-hover:translate-y-0 transition-transform duration-300`}
        >
